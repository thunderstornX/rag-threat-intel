...
sentence-window with $\pm$2 neighbours) drawn from a curated
50-question evaluation set, reporting MRR@5 / MRR@10
\cite{voorhees1999trec8qa} over a 14-query CVE-recall subset (where
ground-truth source IDs are well-defined) and a three-axis
faithfulness pilot (citation density, citation validity, refusal
honesty) over a 12-query subsample, inspired by recent RAG-evaluation
...
with ORCID 0009-0007-2787-943X. This release is archived at
\texttt{10.5281/zenodo.20480466}.
